...
extension MenuBarRootView {
    ...
    private var nodesSearchBar: some View {
        ...
        .background(
            RoundedRectangle(cornerRadius: T.cornerRadius, style: .continuous)
                ...
                .overlay {
                    RoundedRectangle(cornerRadius: T.cornerRadius, style: .continuous)
                        .stroke(nativeControlBorder.opacity(isDarkAppearance ? 0.40 : 0.12),
                                lineWidth: T.stroke)
                })
    ...
    func nodesLocalSection() -> some View {
        ...
        return MeasurementAwareVStack(alignment: .leading, spacing: T.space6, usesLazyStack: false) {
            ...
            if filtered.isEmpty {
                emptyCard(nodesViewModel.searchText.isEmpty
        ...
        HStack(spacing: T.space4) {
            ...
            Button {
                ...
                Image(systemName: "bolt.horizontal")
                    .font(.app(size: T.FontSize.caption, weight: .semibold))
                    .foregroundStyle(self.isHovered
